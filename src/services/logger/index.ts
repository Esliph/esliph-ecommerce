...
import { Injectable, LogLevel, LoggerService, ConsoleLoggerOptions } from '@nestjs/common'
import { Optional } from '@nestjs/common/decorators/core'
...
export class ConsoleLogger implements LoggerService {
    ...
    protected printMessages(messages: unknown[], context = '', logLevel: LogLevel = 'log', writeStreamType: 'stdout' | 'stderr' = 'stdout',) {
    ...
    protected updateAndGetTimestampDiff(): string {
        ...
        const result = includeTimestamp
            ? this.formatTimestampDiff(Date.now() - (ConsoleLogger.lastTimestampAt || Date.now()))
            : ''
